                  ...
                  return Positioned(
                    ...
                    child: Column(
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(builder: (context)=>UserListScreen(initialUserIds: following, title: 'Following')));
                          },
                          child: followFunction('Following ',following.length)),
                        const SizedBox(height: 10),
                        GestureDetector(
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(builder: (context)=>UserListScreen(initialUserIds: follow, title: 'Followers')));
                          },
